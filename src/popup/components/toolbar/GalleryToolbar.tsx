...
export default function GalleryToolbar() {
  ...
  return (
    <div
      className={cn(
        'sticky top-0 z-20 flex shrink-0 items-center justify-between',
        'border-y border-border-subtle bg-surface/95 px-4 py-2 backdrop-blur-sm',
      )}
    >
      <div className="flex min-w-0 items-center gap-2">
        <LayoutGrid size={14} className="shrink-0 text-text-tertiary" />
